...
it("unregisters the active ship, restores its source, and persists the next naval activation", async () => {
  ...
  expect(sent.at(-1)).toMatchObject({
    ...
    data: { requestId: "unregister-active", status: "ACCEPTED" }
  });
