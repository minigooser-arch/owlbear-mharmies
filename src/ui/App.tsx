  ...
  return (
    <main className="app-shell" data-theme="letopis-wiki-light">
      ...
      <div className="content wiki-content">
        ...
        {tab === "ARMIES" && <>
          <ForcesPage armies={state.armies} ships={state.ships} sides={state.sides} role={state.role} playerId={state.playerId} leaderSideIds={state.leaderSideIds} memberSideIds={state.memberSideIds} relations={state.relations} navalRequestTargets={state.navalRequestTargets} transportEmbarkTargets={state.transportEmbarkTargets} pendingTransportEmbarkRequests={state.pendingTransportEmbarkRequests} onAction={send} />
